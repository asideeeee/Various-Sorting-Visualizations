...
second_sort::second_sort(QObject *parent)
    :QThread{parent}
{}

void second_sort:: recInformation(int index,int speed,QVector<int>arr){
    Alogrithm_index=index;
    sort_numbers=arr;
    c_speed=speed;

}
void second_sort::run()
{
    cmp=0;
    swp=0;
...
void second_sort:: swap(int i,int j)
{
